...
abstract class Statement {
     ...
     * @param Limit $limit
     */
    public function __construct(Where $where, Order $order, Limit $limit) {
        $this->Where = $where;
        $this->Order = $order;
        $this->Limit = $limit;
    }
    ...
    public function where($column, $operator = null, $value = null, $chainType = 'AND') {
        $this->values[] = $value;
        $this->Where->where($this->query->identifier($column), $operator, $chainType);
        return $this;
    }
    ...
    public function orWhere($column, $operator = null, $value = null) {
        ...
        $this->Where->orWhere($this->query->identifier($column), $operator);
    ...
    public function whereBetween($column, array $values, $chainType = 'AND') {
        ...
        $this->Where->whereBetween($this->query->identifier($column), $chainType);
    ...
    public function orWhereBetween($column, array $values) {
        ...
        $this->Where->orWhereBetween($this->query->identifier($column));
    ...
    public function whereNotBetween($column, array $values, $chainType = 'AND') {
        ...
        $this->Where->whereNotBetween($this->query->identifier($column), $chainType);
    ...
    public function orWhereNotBetween($column, array $values) {
        ...
        $this->Where->orWhereNotBetween($this->query->identifier($column));
    ...
    public function whereIn($column, array $values, $chainType = 'AND') {
        ...
        $this->Where->whereIn($this->query->identifier($column), $this->getPlaceholders(), $chainType);
    ...
    public function orWhereIn($column, array $values) {
        ...
        $this->Where->orWhereIn($this->query->identifier($column), $this->getPlaceholders());
    ...
    public function whereNotIn($column, array $values, $chainType = 'AND') {
        ...
        $this->Where->whereNotIn($this->query->identifier($column), $this->getPlaceholders(), $chainType);
    ...
    public function orWhereNotIn($column, array $values) {
        ...
        $this->Where->orWhereNotIn($this->query->identifier($column), $this->getPlaceholders());
    ...
    public function whereLike($column, $value = null, $chainType = 'AND') {
        ...
        $this->Where->whereLike($this->query->identifier($column), $chainType);
    ...
    public function orWhereLike($column, $value = null) {
        ...
        $this->Where->orWhereLike($this->query->identifier($column));
    ...
    public function whereNotLike($column, $value = null, $chainType = 'AND') {
        ...
        $this->Where->whereNotLike($this->query->identifier($column), $chainType);
    ...
    public function orWhereNotLike($column, $value = null) {
        ...
        $this->Where->orWhereNotLike($this->query->identifier($column));
    ...
    public function whereNull($column, $chainType = 'AND') {
        $this->Where->whereNull($this->query->identifier($column), $chainType);
    ...
    public function orWhereNull($column) {
        $this->Where->orWhereNull($this->query->identifier($column));
    ...
    public function whereNotNull($column, $chainType = 'AND') {
        $this->Where->whereNotNull($this->query->identifier($column), $chainType);
    ...
    public function orWhereNotNull($column) {
        $this->Where->orWhereNotNull($this->query->identifier($column));
    ...
    public function orderBy($column, $direction = 'ASC') {
        $this->Order->orderBy($this->query->identifier($column), $direction);
    ...
    public function limit($number, $offset = 0, $page = null) {
        $this->Limit->limit($number, $offset, $page);
    ...
    protected function setTable($table) {
        $this->table = $this->query->identifier($table);
        return $this;
    }
